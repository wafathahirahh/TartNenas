 ...
 */
public class UpdatePatientController2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private PatientDAO dao;    
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePatientController2() {
        super();
        dao = new PatientDAO();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("updatePatient2.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("listallPatient.jsp");
		view.forward(request, response);
