						...
						<table>
							...
							<c:forEach items="${appointments}" var="app">
								<tr>
									...
									<td><a href="AppointmentController?action=view&appid=<c:out value="${app.appid}"/>" class="btnAction">View</a>
									<a href="AppointmentController?action=delete&appid=<c:out value="${app.appid}" />" class="btnAction">Delete</a>
									<a href="UpdateAppController2?action=update&appid=<c:out value="${app.appid}"/>" class="btnAction">Update</a>
									</td>
							</c:forEach>
          </table>
        </main>
