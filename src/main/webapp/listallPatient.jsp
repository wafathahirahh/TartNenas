...
<body>
   ...
   <h3 style="text-align:center; margin-top:38px;">Patient List</h3>
        ...
        <input style="margin-left:30px;" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for ID..">
        ...
        <table id="myTable">
            ...
            <c:forEach items="${patients}" var="patient">
                <tr>
                    ...
                    <td>
                        <a href="UpdatePatientController2?action=update&patientid=<c:out value="${patient.patientid}"/>"
                            class="btnAction">Update</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
