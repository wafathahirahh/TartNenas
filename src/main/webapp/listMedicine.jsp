...
<body>
  <!-- NAVIGATION BAR START HERE -->
	...
	<a href="addMedicine.jsp" class="btn">Add Medicine</a><br><br>
	</div>
	</div>
	...
	<table>
		...
		<c:forEach items="${medicines}" var="m" varStatus="medicines">
			<tr>
				...
				<td><a class="btnAction" href="editMedicine?medid=<c:out value="${m.medid}"/>">Update</a></td>
            	<td><button class="btnAction" id="<c:out value="${m.medid}"/>" onclick="confirmation(this.id)">Delete</button></td>    
				</c:forEach>
	</table>
	<script>
